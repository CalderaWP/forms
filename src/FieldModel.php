...
class FieldModel extends Model implements HasForm, HasField,HasValue,HasSlug
{
	use ProvidesValue, ProvidesField, ProvidesForm, ProvidesId, ProvidesName, ProvidesSlug;
}
